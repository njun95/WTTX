...
<head>
  ...
  <link rel="shortcut icon" href="download.jpg" type="image/ico" />
...
<body style="background-image: url('wireless.jpg');">
            ...
            <div class="form-row">
              <div class="col-md-6">
                <div class="form-label-group">
                  ...
                  value="<?php if(isset($_POST['firstName'])) echo $_POST['firstName'];  ?>" <?php if(isset($_POST['firstName'])) { } else {echo ' autofocus="autofocus"' ;} ?> placeholder="First name"required="required">
            ...
            <div class="form-row">
              ...
              <div class="col-md-6">
                <div class="form-label-group">
                  ...
                  value="<?php if(isset($_POST['confirmPassword'])) echo $_POST['confirmPassword']; ?>"class="form-control" placeholder="Confirm password" required="required">
...
if(isset($_POST['register']))
{
  ...
  if($numRows > 0 )
  {
   ...
   echo "<br><div class='alert alert-danger'><strong><h5>AN ACCOUNT WITH THE SAME CREDENTIALS EXISTS!!! </h5><br>Review email <i>and/or</i> fix phone number <i>and/or</i> personal phone number </strong></div>";
  }
  else
  {
