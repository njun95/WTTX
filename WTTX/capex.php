...
?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Capital expenditure and Return of Interest- <?php  if(!isset($_SESSION["ProjectID"]) || empty($_SESSION["ProjectID"])) { echo " ";} else { echo $_SESSION["ProjectName"]; }  ?></li>
        </ol>
        ...
        <div class="card mb-3" >
          <div class="card-header">
            ...
            echo "<p>pleae create a project </p><a href='projectform.php'>click here</a>";}
             ...
             include 'capacity/inputcapexparameters.php'; 
          }
          ?>
